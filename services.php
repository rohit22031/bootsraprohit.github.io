...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="card-body">
    ...
    <a href="https://wallpapers.com/nature" class="btn btn-primary">See Profile</a>
  </div>
</div>
            ...
            <div class="col-lg-4 col-md-4 col-12">
            <div class="card" >
  <img class="card-img-top" src="rs.jpg" alt="Card image">
  <div class="card-body">
    <h4 class="card-title">Beutiful Nature</h4>
    <p class="card-text">Some example text.</p>
    <a href="https://unsplash.com/s/photos/natural" class="btn btn-primary">See Profile</a>
...
<div class="col-lg-4 col-md-4 col-12">
            <div class="card" >
  <img class="card-img-top" src="rw.jpg" alt="Card image">
  <div class="card-body">
    <h4 class="card-title">Beutiful Nature</h4>
    <p class="card-text">Some example text.</p>
    <a href="https://www.shutterstock.com/search/nature-wallpaper" class="btn btn-primary">See Profile</a>
  </div>
</div>
